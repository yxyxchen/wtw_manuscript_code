...
# Questions:
# Why ftilde of B doesn't peak at log(10)
# for prestims, shall we use some things like c(0, 10, 0, 15, ...) (the reset version) or c(0, 10, 12, 27..) (the accumulative version) 
# 
...
if(makepix){
		...
		lines(-log(Ss),ftilde8[,2] , col=rgb(0,1,0,0.5))  # the memory of B
		lines(-log(Ss),ftilde8[,1] , col=rgb(1,0,0,0.5)) # the memory of A
}
