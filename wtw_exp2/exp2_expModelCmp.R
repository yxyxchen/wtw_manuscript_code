expModelCmp = function(){
  ...
  load("expParas.RData")
  dir.create("../../figures/wtw_exp2/expModelCmp")
  ...
  fig4pie = data.frame(
    ...
    ggtitle(sprintf("Exp.2, N = %d", sum(allPass)))
  ggsave("../../figures/wtw_exp2/expModelCmp/4model.eps", fig4pie, width = 4, height = 4)
  ...
  fig4WAIC = data.frame(
    ...
    ylim(c(0, 450))
  fileName = "../../figures/wtw_exp2/expModelCmp/waic_4model.eps"
  ...
  fig6pie = data.frame(
    ...
    theme(legend.position = 'none',
          ...
          axis.title=element_text(size= 20, face = "bold")) +
    ggtitle(sprintf("Exp.2, N = %d", sum(allPass)))
  ggsave("../../figures/wtw_exp2/expModelCmp/6model.eps",  fig6pie, width = 4, height = 4)
  ...
  fig6WAIC = data.frame(
    ...
    scale_fill_manual(values = modelColors) + theme(legend.position = "none") +
    ylim(c(0, 650))
  fileName = "../../figures/wtw_exp2/expModelCmp/waic_6models.eps"
